...
public class QueryPage extends AppCompatActivity {
    ...
    private static final String TAG = "QueryPage";
    private ConversationService myConversationService = null;
    private TextView chatDisplayTV;
    private EditText userStatementET;
    private final String IBM_USERNAME = "hidden";
    private final String IBM_PASSWORD = "hidden";
    private final String IBM_WORKSPACE_ID = "hidden";
